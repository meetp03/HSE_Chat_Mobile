class ApiUrls {
  ...
  static const String conversations = '${baseUrl}/api/messages/conversations-list';
  ...
  static const String getNotification = '${baseUrl}/api/notifications/get-notifications';
  static const String markAllNotificationsRead = '${baseUrl}/api/notifications/mark-all-read';
  // Chat URLs
  ...
  static const String sendChatRequest = '${baseUrl}/api/messages/send-chat-request';
}
